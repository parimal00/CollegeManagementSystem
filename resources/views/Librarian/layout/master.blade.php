                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{ url('/books') }}"><i class="fa fa-home"></i> Add books <span
                                            class="fa fa-chevron-down"></span></a>

                                </li>
                                <li><a href="{{ url('/deleteBooks') }}"><i class="fa fa-edit"></i>Delete books<span
                                            class="fa fa-chevron-down"></span></a>

                                </li>
                                <li><a href="{{ url('/issue_books') }}"><i class="fa fa-desktop"></i> Issue Books <span
                                            class="fa fa-chevron-down"></span></a>
