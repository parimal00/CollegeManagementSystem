...
@section('body')
    ...
    <form class="" action="{{ route('deleteBus.index') }}" method="post">
        @csrf
        <table class="table">
...
?>
    @foreach ($datas as $row)
        ...
        <table class="table table-bordered">
            <form action="busAccount" method="post">
                @method('Delete')
                @csrf
                <tr>
                    <td>Roll No</td>
                ...
                <tr>
                    <td><button name="btn_addData" class="form-control">Delete Bus Fee</button></td>
                </tr>
            </form>
        </table>
    @endforeach
