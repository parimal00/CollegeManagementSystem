                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="allStudents"><i class="fa fa-edit"></i> All Student Info <span class="fa fa-chevron-down"></span></a>

                            <li><a href="{{Route('bus_fee.index')}}"><i class="fa fa-home"></i> Bus fee <span class="fa fa-chevron-down"></span></a>
